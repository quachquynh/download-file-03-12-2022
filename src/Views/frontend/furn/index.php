<?php require 'header.php';?>
						...
						<div class="col-md-3">
							<div class="single-populer-products">
								<div class="single-populer-product-img mt40">
									<img src="<?php echo APP_URL;?>/frontend/furn/assets/images/populer-products/p1.png" alt="populer-products images">
								</div>
									...
									<div class="row">
										<div class="col-md-4 col-sm-12">
											<div class="single-inner-populer-product-img">
												<img src="<?php echo APP_URL;?>/frontend/furn/assets/images/populer-products/p2.png" alt="populer-products images">
											</div>
										</div>
							...
							<div class="single-populer-products">
								<div class="single-populer-products">
									<div class="single-populer-product-img">
										<img src="<?php echo APP_URL;?>/frontend/furn/assets/images/populer-products/p3.png" alt="populer-products images">
									</div>
		...
		<?php require 'template-parts/home/new-arrivals.php';?>
					...
					<div class="row">
						<div class="col-sm-3">
							<div class="single-feature">
								<img src="<?php echo APP_URL;?>/frontend/furn/assets/images/features/f1.jpg" alt="feature image">
						...
						<div class="col-sm-3">
							<div class="single-feature">
								<img src="<?php echo APP_URL;?>/frontend/furn/assets/images/features/f2.jpg" alt="feature image">
								<div class="single-feature-txt text-center">
									<p>
										<i class="fa fa-star"></i>
										<i class="fa fa-star"></i>
						...
						<div class="col-sm-3">
							<div class="single-feature">
								<img src="<?php echo APP_URL;?>/frontend/furn/assets/images/features/f3.jpg" alt="feature image">
								<div class="single-feature-txt text-center">
									<p>
										<i class="fa fa-star"></i>
										<i class="fa fa-star"></i>
						...
						<div class="col-sm-3">
							<div class="single-feature">
								<img src="<?php echo APP_URL;?>/frontend/furn/assets/images/features/f4.jpg" alt="feature image">
								<div class="single-feature-txt text-center">
									<p>
										<i class="fa fa-star"></i>
										<i class="fa fa-star"></i>
		...
		<?php require 'template-parts/home/blog.php';?>

		<?php require 'template-parts/home/clients.php';?>
