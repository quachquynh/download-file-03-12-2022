...
<body>
    <div class="phppot-container tile-container">
        <form id="uploadForm" action="<?php echo ROOTURL;?>/fpt/upload" method="post" enctype="multipart/form-data">

            <h2 class="text-center">Progress Bar</h2>
            <div>
                <div class="row">
                    <label>Upload Image File:</label> <input
                        name="userImage" id="userImage" type="file" class="full-width" required multiple="multiple">
                </div>
                <div class="row">
                ...
                <button id="btn-submit" name="btn-submit">Submit</button>
            </div>
        </form>
